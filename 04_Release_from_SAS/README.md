...
I can use the full reference genome, including the X' inversion scaffold. Again I will map reads from all libraries to this full genome, and then for gynogenic females add up the counts for the X and X' homologs.
